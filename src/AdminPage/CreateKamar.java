 ...
 * @author HP
 */
public class CreateKamar extends javax.swing.JFrame {

    /**
     * Creates new form CreateKamar
     */
    public CreateKamar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 80, -1, 380));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateKamar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreateKamar().setVisible(true);
            }
        });
    }
